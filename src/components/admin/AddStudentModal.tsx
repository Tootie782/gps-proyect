...
interface AddStudentModalProps {
  isOpen: boolean;
  onClose: () => void;
  onAdd: (student: NewStudentData) => void;
  schools: School[];
}

export function AddStudentModal({ isOpen, onClose, onAdd, schools }: AddStudentModalProps) {
        ...
        <form onSubmit={handleSubmit} className="space-y-4 p-6">
          ...
          <div>
            ...
            <input
              ...
              required
              className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
              placeholder="Ej: j.carrera@example.com"
            />
          </div>
