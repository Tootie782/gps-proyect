...
interface AssignStudentToCourseModalProps {
  isOpen: boolean;
  onClose: () => void;
  onSave: (studentId: number, courseLevel: string, courseSection: string) => void;
...
export function AssignStudentToCourseModal({ isOpen, onClose, onSave, student }: AssignStudentToCourseModalProps) {
  ...
  const handleSubmit = () => {
    if (student && selectedLevel && selectedSection) {
      onSave(student.id, selectedLevel, selectedSection);
      onClose();
    }
  };
      ...
      >
        ...
        <div className="flex items-center justify-between border-b p-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-xl font-semibold text-gray-800">Asignar a Curso</h2>
        ...
        <div className="p-6 space-y-6">
          <p className="text-sm text-gray-600">
            Selecciona el curso al cual el estudiante será asignado. Las materias se asignarán automáticamente según el curso.
          </p>
          ...
          {selectedLevel && selectedSection && (
            <div className="p-4 bg-green-50 rounded-lg border border-green-200">
              ...
              <p className="text-xs text-green-700 mt-1">
                El estudiante tendrá acceso a todas las materias de este curso.
              </p>
            </div>
          )}
        </div>
