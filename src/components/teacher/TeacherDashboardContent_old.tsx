    ...
    teacher.horarioSemanal.forEach(clase => {
      ...
      if (!schoolsMap.has(key)) {
        schoolsMap.set(key, {
          ...
          aula: clase.aula,
          descripcion: `${clase.curso} en ${clase.escuela}`,
          horario: [],
          actividades: []
        });
      }
                ...
                {activeTab === 'schedule' ? (
                  ...
                  <div className="h-[400px]">
                    <div className="flex items-center justify-between p-4 border-b border-gray-200">
                      <h3 className="text-sm font-semibold text-gray-900">Mis Actividades</h3>
                      <button className="flex items-center gap-1 px-3 py-1.5 text-xs font-medium text-blue-600 hover:text-blue-700 hover:bg-blue-50 rounded-md transition-colors">
                        <Plus className="w-3 h-3" />
                        Nueva
                      </button>
                    </div>
              ...
              <div className="col-span-1 min-h-0">
                <div className="bg-white rounded-lg border border-gray-200 h-full flex flex-col">
                  <div className="flex items-center justify-between p-4 border-b border-gray-200 flex-shrink-0">
                    <h3 className="text-sm font-semibold text-gray-900">Mis Actividades</h3>
                    <button className="flex items-center gap-1 px-2 py-1 text-xs font-medium text-blue-600 hover:text-blue-700 hover:bg-blue-50 rounded transition-colors">
                      <Plus className="w-3 h-3" />
                      Nueva
                    </button>
                  </div>
